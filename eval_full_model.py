...
try:
    _DATA_DIR ='/data1/jhliu/CNN/finished_files/'
except KeyError:
...
if __name__ == '__main__':
    ...
    metric_opt = parser.add_mutually_exclusive_group()
    metric_opt.add_argument('--rouge', action='store_true',
                            help='ROUGE evaluation',default=True)
    metric_opt.add_argument('--meteor', action='store_true',
                            help='METEOR evaluation',default=False)

    parser.add_argument('--decode_dir', action='store',
                        help='directory of decoded summaries',default='/home/wanglihan/decoded4dotgg1/file')
