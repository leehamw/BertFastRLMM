...
if __name__ == '__main__':
    ...
    parser.add_argument('--path',  help='root of the model',default='/home/wanglihan/abstractor/model')
    ...
    parser.add_argument('--w2v', action='store',
                        help='use pretrained word2vec embedding',default='/home/wanglihan/word2vec/word2vec.128d.226k.bin')
    ...
    parser.add_argument('--patience', type=int, action='store', default=15,
